...
if (shooter === "p1" && collision(ball, p2)) resetBall();
if (shooter === "p2" && collision(ball, p1)) resetBall();
if (shooter === "p1" && ballPos.x > 900 && ballPos.y > 200 && ballPos.y < 290) {
score1 += 2;
updateScore();
resetBall();
}
if (shooter === "p2" && ballPos.x < 40 && ballPos.y > 200 && ballPos.y < 290) {
score2 += 2;
updateScore();
resetBall();
}
if (ballPos.y > 500) resetBall();
ball.style.left = ballPos.x + "px";
ball.style.top = ballPos.y + "px";
}
